    ...
    return (
        <section id="about" className="py-20 bg-white dark:bg-slate-900">
            <div className="align-element">
                ...
                ring-1 ring-slate-200 dark:ring-slate-700 h-[950px]">
                            <Image
                    ...
                    <article className="flex flex-col justify-start">
                        {lang === 'fa' ? (
                            ...
                            <div className="space-y-6 text-justify font-sans text-xl leading-relaxed text-slate-700 dark:text-slate-300">
                                <p>
