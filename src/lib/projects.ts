...
export const projects: Project[] = [
    {
        ...
        description: "یک اپلیکیشن مدرن و واکنش‌گرا در بخش فرانت‌اند است که با React توسعه داده شده است. این داشبورد اطلاعات لحظه‌ای مربوط به رزروها، فعالیت‌های مهمانان و داده‌های فروش را از طریق نمودارها، جداول و اعلان‌های تعاملی نمایش می‌دهد. با پشتیبانی از حالت تاریک و روشن (dark/light mode) و رابط کاربری روان، این پروژه بستری حرفه‌ای برای مدیریت چک‌این و چک‌اوت مهمانان و فعالیت‌های روزانه با تمرکز بر کاربرپسندی و وضوح اطلاعات ارائه می‌دهد.",
