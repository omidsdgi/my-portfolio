...
export default function ProjectsPage() {
    return (
        <main className="max-w-7xl   mx-auto px-4 py-12">
            <h1 className="text-5xl font-quicksand font-bold mb-8">Projects</h1>
            ...
            <div className="grid md:grid-cols-2 gap-12">
                {projects.map((p) => (
                    ...
                    >
                        ...
                        <p className="text-black font-tahoma text-lg mb-4 text-justify flex-grow dark:text-white" dir="rtl">
                            {p.description}
                        </p>
